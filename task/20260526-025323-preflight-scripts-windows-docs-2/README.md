# 分发化：preflight + scripts + Windows 启动 + docs 衔接（第2轮）

## Task Info

| Field | Value |
|---|---|
| Task ID | 20260526-025323-preflight-scripts-windows-docs-2 |
| Title | 分发化：preflight + scripts + Windows 启动 + docs 衔接（第2轮） |
| Category | Other |
| Status | created |
...
Query usage from this workflow repo: `npm run assistant -- usage --task 20260526-025323-preflight-scripts-windows-docs-2 --by role`
